                        ...
                        {widgets.map((widget, index) => (
                          <motion.div
                            ...
                            style={{
                              ...
                              height: WIDGET_HEIGHTS[widget.type]
                            }}
                            className="bg-white rounded-2xl border border-gray-100 p-4 relative group flex flex-col shadow-sm hover:shadow-md transition-shadow"
                          >
                            {/* Colored top bar */}
                  ...
                  >
                    {widgets.map((widget) => (
                      ...
                      >
                        ...
                        <div className="drag-handle flex items-center justify-between px-4 pt-3 pb-2 flex-shrink-0 cursor-grab active:cursor-grabbing">
                          <div className="flex items-center gap-2">
                            {/* Drag indicator */}
                            <div className="flex flex-col gap-0.5 opacity-30 group-hover:opacity-60 transition">

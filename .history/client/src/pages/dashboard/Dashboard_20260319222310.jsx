              ...
              {widgets.length === 0 ? (
                <div className="bg-white rounded-2xl border-2 border-dashed border-gray-200 flex flex-col items-center justify-center min-h-96 text-center p-8">
                  ...
                  <p className="text-gray-400 text-sm mt-2">
                    Click any widget from the left panel to add it
                  </p>
                </div>
              ) : (
                <div className="grid grid-cols-12 gap-4">
                  {widgets.map((widget) => (
                    <motion.div
                      ...
                      style={{ height: WIDGET_HEIGHTS[widget.type] }}
                      className={`col-span-${Math.min(widget.width, 12)} bg-white rounded-2xl border border-gray-200 p-4 relative group flex flex-col`}
                    >
                      {/* Widget Header */}
              ...
              <div className="grid grid-cols-12 gap-4">
                {widgets.map((widget) => (
                  <motion.div
                    ...
                    style={{ height: WIDGET_HEIGHTS[widget.type] }}
                    className={`col-span-${Math.min(widget.width, 12)} bg-white rounded-2xl border border-gray-200 p-4 flex flex-col`}
                  >

...
// Defined OUTSIDE the component so they never get recreated
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="col-span-2">
                    <InputField label="Street address" name="streetAddress" placeholder="123 Main St"
                      value={formData.streetAddress} onChange={handleChange} error={errors.streetAddress} />
                  </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="col-span-2">
                    <SelectField label="Choose product" name="product" options={PRODUCTS}
                      value={formData.product} onChange={handleChange} error={errors.product} />
                  </div>
                  ...
                  <SelectField label="Created by" name="createdBy" options={CREATORS}
                    value={formData.createdBy} onChange={handleChange} error={errors.createdBy} />
                </div>
              </div>
